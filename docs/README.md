...
- `guides/`：操作與使用教學
- `reports/`：功能完成、優化與修復報告
- `archive/legacy/`：舊版備份與歷史文件

## guides/

- [開始使用.md](guides/開始使用.md)
- [快速開始.md](guides/快速開始.md)
...
- [作品集更新報告.md](reports/作品集更新報告.md)
- [修復報告.md](reports/修復報告.md)
- [功能完成報告.md](reports/功能完成報告.md)
- [功能完成總結報告.md](reports/功能完成總結報告.md)
- [文件結構整理報告.md](reports/文件結構整理報告.md)
- [新功能說明.md](reports/新功能說明.md)
...
- 新的操作教學請放在 `guides/`
- 版本完成與修復紀錄請放在 `reports/`
- 不再維護但需要保留的舊文檔移至 `archive/legacy/`
